...
> 최종 검증: 2026-07-18. 이 블록이 "현재 상태"의 기준값이다. 다른 문서는 여기를 인용하거나 링크한다.
...
- 테스트 상태: `cargo test` 통과 — unit test 310개 + fixture smoke 4개. `cargo clippy --all-targets -- -D warnings` 무경고.
...
- 직접 dependency: `base64 0.22.1`, `serde 1.0.228`, `serde_json 1.0.145`, `zip 8.5.1`.
